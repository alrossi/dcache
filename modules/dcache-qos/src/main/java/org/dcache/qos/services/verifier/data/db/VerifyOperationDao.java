...
/**
 * Data Access Object abstraction for FileQoSOperation persistence.
 *
...
public interface VerifyOperationDao {
    ...
    /**
     * Fluent interface to define FileQoSOperation field values.
     */
    ...
    /**
     * Returns a field value builder based on the fields
     * of the file operation which can change while being processed.
     */
    ...
    /**
     * Returns the FileQoSOperations matching a selection criterion with an
     * upper limit on the number of FileQoSOperations returned.
     */
    List<VerifyOperation> get(VerifyOperationCriterion criterion, int limit);

    /**
     * Returns the FileQoSOperation matching a unique criterion.
     *
     * @return The matching FileQoSOperation or null if the criterion did not match a FileQoSOperation
     * @throws IncorrectResultSizeDataAccessException if more than one
     * FileQoSOperation has been found for the given criterion.
     */
    @Nullable
    ...
    /**
     * Updates a specific FileQoSOperation with the given field values.
     *
    ...
    /**
     * Deletes all FileQoSOperations matching a selection criterion.
     */
